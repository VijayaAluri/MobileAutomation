...
/** This class is to Initiate the Appium driver and Load the desired Capabilities
 * This class is also having a method to close the App oncethe execution is completed
 * @author Vijaya
 */
